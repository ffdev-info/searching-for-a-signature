...
* The ASCII view of a plain text file might look sensible
* The ASCII view of an image or other 'binary' file may have
some parts that are human readable, but will mostly seem noisy!
...
* Hex Editors are used in File Forensics, reverse engineering, understanding
file formats at a low-level
* Remember *Safety First* - it’s called an ‘editor’ for a reason, so to
